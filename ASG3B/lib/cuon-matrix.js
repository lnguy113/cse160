...
class Vector3 
{
    ...
    static cross(other1, other2) 
    {
        ...
        //beginning 
        var first = other1.elements[1] * other2.elements[2];
        var second = other1.elements[2] * other2.elements[1];
        v3.elements[0] = first - second;

        //middle
        var first = other1.elements[0] * other2.elements[2];
        var second = (other1.elements[2] * other2.elements[0]);
        v3.elements[1] = -(first - second);

        //end
        var first = other1.elements[0] * other2.elements[1];
        var second = other1.elements[1] * other2.elements[0];
        v3.elements[2] = first - second;
    ...
    normalize() 
    {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        var storemag = this.magnitude();

        for (let i=0; i<3; i++)
        {
            this.elements[i] = this.elements[i] / storemag;
        }
        // Don't delete the return statement.
        return this;
    };
